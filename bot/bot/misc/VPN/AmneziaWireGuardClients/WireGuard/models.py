...
class ClientModel(BaseModel):
    ...
    expired_at: datetime | None = Field(None, alias="expiredAt")
    one_time_link: str | None = Field(None, alias="oneTimeLink")
    one_time_link_expires_at: datetime | None = Field(None, alias="oneTimeLinkExpiresAt")
    downloadable_config: bool = Field(..., alias="downloadableConfig")
    persistent_keepalive: str | None = Field(None, alias="persistentKeepalive")
    latest_handshake_at: datetime | None = Field(None,alias="latestHandshakeAt")
    transfer_rx: int | None = Field(None, alias="transferRx")
    transfer_tx: int | None = Field(None, alias="transferTx")
